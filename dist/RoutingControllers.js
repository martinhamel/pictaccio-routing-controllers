...
class RoutingControllers {
    ...
    registerControllers(classes) {
        ...
        controllers.forEach(controller => {
            controller.actions.forEach(actionMetadata => {
                ...
                const viewAction = (0, index_1.getMetadataArgsStorage)().responseHandlers
                    .filter(handler => handler.type === 'view' && handler.method === actionMetadata.method)[0];
                const controllerInstance = controller.getInstance(actionMetadata);
     ...
     */
    executeAction(actionMetadata, action, viewAction, interceptorFns) {
