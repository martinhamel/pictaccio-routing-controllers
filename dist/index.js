...
__exportStar(require("./decorator/ViewRender"), exports);
__exportStar(require("./decorator/ViewObj"), exports);
...
__exportStar(require("./metadata/types/OwnershipChecker"), exports);
...
__exportStar(require("./BaseView"), exports);
...
function createExecutor(driver, options = {}) {
    ...
    driver.classToPlainTransformOptions = (_a = options.classToPlainTransformOptions) !== null && _a !== void 0 ? _a : {};
    driver.plainToClassTransformOptions = (_b = options.plainToClassTransformOptions) !== null && _b !== void 0 ? _b : {};
...
function createParamDecorator(options) {
    return function (object, method, index) {
        ...
        getMetadataArgsStorage().params.push({
            ...
            index: index,
            parse: false,
            required: (_a = options.required) !== null && _a !== void 0 ? _a : false,
